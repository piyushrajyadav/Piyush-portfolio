...
function BentoRoleCard({ service, index, isActive, onSelect }) {
  const getBentoSpan = () => {
    switch (service.id) {
      case "ai-engineer":
        return "col-span-12 lg:col-span-7 min-h-[290px]";
      case "software-developer":
        return "col-span-12 lg:col-span-5 min-h-[290px]";
      case "frontend-developer":
        return "col-span-12 sm:col-span-6 lg:col-span-4 min-h-[270px]";
      case "backend-developer":
        return "col-span-12 sm:col-span-6 lg:col-span-4 min-h-[270px]";
      case "devops-engineer":
        return "col-span-12 sm:col-span-12 lg:col-span-4 min-h-[270px]";
      default:
...
function Services() {
  const [selectedId, setSelectedId] = useState("ai-engineer");
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 my-16 md:my-24 relative z-10">
      {/* Section Header */}
      <motion.div
      ...
      >
        <p className="sectionSubText text-slate-500 dark:text-gray-300">Overview & Capabilities</p>
        <h2 className="sectionHeadText text-slate-900 dark:text-white">Roles & Specializations.</h2>
      </motion.div>
      ...
      <div className="grid grid-cols-12 gap-5 md:gap-6">
        {services.map((service, index) => (
          <BentoRoleCard
            ...
            service={service}
            index={index}
            isActive={selectedId === (service.id || service.title)}
